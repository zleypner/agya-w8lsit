      ...
      <div className="relative z-10">
        ...
        <section className="py-16 md:py-20">
          <div className="max-w-4xl mx-auto px-4">
            <div className="card-friendly p-8 md:p-10 animate-fade-in-up">
              <SectionHeader
                title="AgendaYaa está diseñado para fisioterapeutas"
                subtitle="Una plataforma que entiende tu práctica: seguimiento de evolución, planes de rehabilitación, comunicación con pacientes y gestión de sesiones adaptadas al progreso. Todo enfocado en mejorar los resultados de tus tratamientos."
                variant="dark"
              />
            </div>
          </div>
        ...
        <WaitlistSection
          ...
          subtitle="Sumate y te avisamos cuando abramos acceso para fisioterapeutas. Entrás temprano, asegurás precio fundador."
          niche="fisioterapia"
        />
      </div>
    </div>
